...
class MyHandymanWidget extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text('My ${languages!.provider}', style: boldTextStyle(size: 20)),
          32.height,
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            4.height,
                            DisabledRatingBarWidget(rating: data.providers_service_rating.validate()),
                          ],
                        ).expand(),
                      ],
                    ),
