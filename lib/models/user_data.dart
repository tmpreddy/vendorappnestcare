...
class UserData {
  ...
  UserData.fromJson(Map<String, dynamic> json) {
    ...
    providers_service_rating = json['providers_service_rating'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['providers_service_rating'] = this.providers_service_rating;
